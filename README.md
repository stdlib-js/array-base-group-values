...
```javascript
import groupValues from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-group-values@v0.2.4-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-group-values/actions/workflows/test.yml/badge.svg?branch=v0.2.4
[test-url]: https://github.com/stdlib-js/array-base-group-values/actions/workflows/test.yml?query=branch:v0.2.4
