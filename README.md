...
```javascript
groupValues = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-group-values@v0.2.4-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-group-values@v0.2.4-umd/browser.js"></script>
```
